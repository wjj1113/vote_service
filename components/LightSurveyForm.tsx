...
export default function LightSurveyForm({ onSubmit }: { onSubmit: (answers: any) => void }) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-xl">
      <div className="mb-8 text-center">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 rounded-full mb-4">
          <Flag className="w-8 h-8 text-blue-600" />
        </div>
        <h2 className="text-2xl font-bold text-gray-800 mb-2">정치 성향 설문조사</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <label className="text-lg font-semibold text-gray-800">정치 성향</label>
            ...
            {['진보', '보수', '중도', '실용주의'].map(opt => (
              ...
              `}>
                ...
                <div className={`
                  ...
                  ${answers.tendency === opt ? 'border-blue-500 bg-blue-500' : 'border-gray-300'}
                `}>
                  {answers.tendency === opt && <div className="w-2 h-2 bg-white rounded-full" />}
                </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <label className="text-lg font-semibold text-gray-800">가치 기준</label>
            <span className="text-red-500 ml-1">*</span>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <label className="text-lg font-semibold text-gray-800">관심 정책</label>
            <span className="text-red-500 ml-1">*</span>
            <span className="text-sm text-gray-500 ml-2">(복수 선택 가능)</span>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <label className="text-lg font-semibold text-gray-800">기타 의견</label>
